...
# parser.add_argument('-t', '--threshold', type = float, help = 'AP method')
...
for category in type3:
    ...
    # 对groundtruth进行加载
    groundtruth_file = open(os.path.join(args.groundtruth, 'tt100k_%s_3cate.txt' % category))
